...
faq:
  ...
  - question: '¿Por qué mi equipo Linux headless muestra una pantalla en negro?'
    answer: 'Sin un monitor conectado, X o Wayland nunca asignan un framebuffer, por lo que no hay nada que RustDesk pueda capturar y el visor muestra una pantalla en negro o de espera de imagen. Conecta un conector ficticio HDMI/DisplayPort.'
...
3. Para acceder antes del inicio de sesión o entre distintas sesiones de usuario, configura la propia pantalla de inicio de sesión del gestor de pantalla para usar X11/Xorg donde sea compatible; elegir una sesión de escritorio X11 solo afecta a la sesión posterior al inicio de sesión.
...
Hay dos formas de darle algo que renderizar:
