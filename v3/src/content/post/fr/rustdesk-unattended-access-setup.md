...
| Linux      | Installer le paquet du service                                               | Wayland nécessite une session active ; pour l'accès avant connexion, utilisez X11 là où une distribution en propose encore un                                             |
