...
faq:
  ...
  - question: 'Wie behebe ich „waiting for image" bei RustDesk auf einem Headless-Rechner?'
    answer: 'Ein Rechner ohne Monitor hat keinen Framebuffer, den man erfassen könnte, sodass RustDesk nichts zu senden hat. Schließen Sie einen echten Monitor an oder stecken Sie einen günstigen HDMI-Dummy-Stecker ein, der die GPU glauben lässt, ein Display sei angeschlossen. Das Aufwecken oder dauerhafte Wachhalten des Displays löst die meisten Fälle.'
...
Es gibt zwei Wege, um etwas zum Erfassen bereitzustellen:
...
| ------------------------------------ | ---------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Headless / kein Display              | Schwarzer Bildschirm bei Server oder Mini-PC   | Monitor anschließen oder HDMI-Dummy-Stecker verwenden                                                                                                                      |
