...
excerpt: 'RustDesk unter Linux installieren und betreiben: .deb, .rpm, Flatpak und AppImage, X11 vs. Wayland, unbeaufsichtigter Zugriff sowie Self-Hosting des Servers.'
...
metadata:
  description: 'RustDesk unter Linux, von A bis Z: Paketwahl für jede Distribution und jedes ARM-Board, Wayland- und X11-Erfassung und der Betrieb eines eigenen Servers.'
...
Dieser Leitfaden zeigt, wie Sie RustDesk installieren, erklärt den einen Punkt, über den alle stolpern (X11 versus Wayland), wie Sie unbeaufsichtigten Zugriff zum Laufen bringen, und wo der Server ins Spiel kommt.
